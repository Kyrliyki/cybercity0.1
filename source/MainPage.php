			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="content" style="max-width: 600px;">
						<h1>Здравствуй <b><?php echo $_SESSION["username"]; ?></b></h1>
						<div style="display: flex; align-items: center; justify-content: space-between;">
							<h2>Создать нового пользователя</h2>
							<a href="CreateUser.php">Создать</a>
						</div>
						<div style="display: flex; align-items: center; justify-content: space-between;">
							<h2>Показать информацию об учениках</h2>
							<a href="AdminInfo.php">Показать</a>
						</div>
	...
	<div class="container">
		...
		<div class="right">
			...
			<div class="content" style="max-width: 600px;">
				...
				<div style="display: flex; align-items: center; justify-content: space-between;">
					<h2>Алгебра</h2>
					<a href="AdminGrade.php?id_object=1" style="display: inline-flex; align-items: center; padding: 5px 10px; margin-left: 10px; text-decoration: none; background-color: #6E44FF; color: #FFF; border-radius: 5px;">Показать!</a>
				</div>
				<?}?><?php if($_SESSION['russian_language'] === 1){?>
				<div style="display: flex; align-items: center; justify-content: space-between;">
					<h2>Русский язык</h2>
					<a href="AdminGrade.php?id_object=2" style="display: inline-flex; align-items: center; padding: 5px 10px; margin-left: 10px; text-decoration: none; background-color: #6E44FF; color: #FFF; border-radius: 5px;">Показать!</a>
				</div>
				<?}?><?php if($_SESSION['Biology'] === 1){?>
				<div style="display: flex; align-items: center; justify-content: space-between;">
					<h2>Биология</h2>
					<a href="AdminGrade.php?id_object=3" style="display: inline-flex; align-items: center; padding: 5px 10px; margin-left: 10px; text-decoration: none; background-color: #6E44FF; color: #FFF; border-radius: 5px;">Показать!</a>
				</div>
				<?}?><?php if($_SESSION['Chemistry'] === 1){?>
				<div style="display: flex; align-items: center; justify-content: space-between;">
					<h2>Химия</h2>
					<a href="AdminGrade.php?id_object=4" style="display: inline-flex; align-items: center; padding: 5px 10px; margin-left: 10px; text-decoration: none; background-color: #6E44FF; color: #FFF; border-radius: 5px;">Показать!</a>
				</div>
				<?}?><?php if($_SESSION['History'] === 1){?>
				<div style="display: flex; align-items: center; justify-content: space-between;">
					<h2>История</h2>
					<a href="AdminGrade.php?id_object=5" style="display: inline-flex; align-items: center; padding: 5px 10px; margin-left: 10px; text-decoration: none; background-color: #6E44FF; color: #FFF; border-radius: 5px;">Показать!</a>
				</div>
				<?}?>
				<div class="logout"><a href="logout.php">Выйти</a></div>
			</div>
